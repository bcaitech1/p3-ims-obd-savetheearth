...
class CosineWarmupRestarts(_LRScheduler):
    def __init__(self, optimizer, T_0, T_mult=1, eta_max=0.1, T_up=0, gamma=1., last_epoch=-1):
        ...
        super(CosineWarmupRestarts, self).__init__(optimizer, last_epoch)
...
_scheduler_entrypoints = {
    ...
    'CosineAnnealingWarmupRestarts': CosineWarmupRestarts
}
